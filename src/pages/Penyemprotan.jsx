...
import { FHHeader } from "../components/ui";
import { useTheme, moduleColor } from "../theme/tokens";
...
// ─── App utama ─────────────────────────────────────────────────────────────────
export default function Penyemprotan({ onBack, onSuccess }) {
    ...
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#0a1e2e 0%,#0d2d45 60%,#0a1a2e 100%)", fontFamily:"'DM Sans','Segoe UI',sans-serif", color:"#e3f2fd", display:"flex", flexDirection:"column" }}>
      ...
      {onBack && (
        <div style={{
          ...
          <span style={{ fontSize: 15, fontWeight: 700, color: "#fff" }}>Kembali ke Menu</span>
        </div>
      )}
